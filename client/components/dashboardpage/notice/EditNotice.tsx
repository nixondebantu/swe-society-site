                    ...
                    <form className="flex flex-col space-y-5">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => handleNoticeChange("notice_body", e.target.value)}
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className='flex items-center space-x-2'>
                                <Input type="file" onChange={handleFileChange} className="w-full border-2 border-input" />
                                {uploadingStatus === 'uploading' && <span className="text-yellow-600 font-bold">Uploading...</span>}
                                {uploadingStatus === 'success' && <span className="text-green-600 font-bold">Uploaded</span>}
                                {uploadingStatus === 'error' && <span className="text-red-600 font-bold">Upload failed</span>}
                            </div>
                        </div>

                        <div className="flex items-center space-x-2">
                            <Checkbox id="terms" />
                            <label htmlFor="terms" className="text-sm font-medium">Notify all members</label>
                        </div>
                    </form>
                </AlertDialogHeader>
                <AlertDialogFooter>
