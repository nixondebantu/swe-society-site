...
exports.updateRole = exports.updateDefaultRole = exports.getRoleInfo = exports.getRoleById = exports.getAllRole = exports.deleteRole = exports.createRole = void 0;
...
const getRoleInfo = (0, errorWrapper_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { rows } = yield dbconnect_1.default.query(`
      SELECT 
        Roles.roleid, 
        Roles.roletitle, 
        Roles.isDefaultRole,
