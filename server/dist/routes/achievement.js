...
router.route("/post").get(achievement_1.getUserAchievementsAll);
...
router.route("/post/fullachievement").post(validateBearerToken_1.validateBearerToken, achievement_1.createTeamAndAchievement);
