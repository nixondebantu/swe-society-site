...
roleRoute.put("/default/:roleid", validateBearerToken_1.validateBearerToken, role_1.updateDefaultRole);
roleRoute.get("/info", validateBearerToken_1.validateBearerToken, role_1.getRoleInfo);
